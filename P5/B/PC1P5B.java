...
public class PC1P5B {
    ...
    public static void main(String[] args) {
        ...
        JobConf job_conf1 = new JobConf(PC1P5B.class);
        job_conf1.setJobName("PC1P5B");
        job_conf1.setOutputKeyClass(Text.class);
        job_conf1.setOutputValueClass(Text.class);
        job_conf1.setMapperClass(pc1p5b.TMDBMapper.class);
        job_conf1.setReducerClass(pc1p5b.TMDBReducer.class);
