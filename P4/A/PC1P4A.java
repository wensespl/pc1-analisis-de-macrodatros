...
public class PC1P4A {
    ...
    public static void main(String[] args) {
        ...
        JobConf job_conf1 = new JobConf(PC1P4A.class);
        job_conf1.setJobName("PC1P4A");
        job_conf1.setOutputKeyClass(Text.class);
        job_conf1.setOutputValueClass(Text.class);
        job_conf1.setMapperClass(pc1p4a.TMDBMapper.class);
        job_conf1.setReducerClass(pc1p4a.TMDBReducer.class);
