...
public class PC1P3 {
    ...
    public static void main(String[] args) {
        ...
        JobConf job_conf1 = new JobConf(PC1P3.class);
        job_conf1.setJobName("PC1P3");
        job_conf1.setOutputKeyClass(Text.class);
        job_conf1.setOutputValueClass(Text.class);
        job_conf1.setMapperClass(pc1p3.TMDBMapper.class);
        job_conf1.setReducerClass(pc1p3.TMDBReducer.class);
